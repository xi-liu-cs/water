...
public class fluid1 : MonoBehaviour
{
    [Header("particle")]
    ...
    public void Update()
    {
        compute_shader.Dispatch(clear_hash_grid_kernel, dispatch_size, 1, 1);
    ...
    public unsafe void compute_buffer_init()
    {
        ...
        hash_grid_buffer = new ComputeBuffer(dimension3 * max_particles_per_grid, sizeof(int));
        hash_grid_tracker_buffer = new ComputeBuffer(dimension3, sizeof(int));
        neighbor_buffer = new ComputeBuffer(n_particle * max_particles_per_grid * 27, sizeof(int));
        ...
        compute_shader.SetBuffer(compute_neighbor_kernel, "hash_grid", hash_grid_buffer);
        compute_shader.SetBuffer(compute_neighbor_kernel, "hash_grid_tracker", hash_grid_tracker_buffer);
